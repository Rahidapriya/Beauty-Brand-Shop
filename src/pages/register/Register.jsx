...
theme: "colored", 
    ...
    return (
        <div className=" bg-pink-200">
          <Navbar></Navbar>
          <div className="mx-auto w-full lg:w-3/12 mt-20 bg-white" data-aos="fade-right">
  ...
  <h4 className=" text-center text-5xl font-bold block font-sans text-[#eeab34] leading-snug tracking-normal text-blue-gray-900 antialiased">
    Sign <span className="text-[#EE4E34]">Up</span> 
  </h4>
  ...
  <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 py-6 rounded-md px-6 shadow-md">
    ...
    <div className="inline-flex items-center">
      ...
      >
        <p className="flex items-center font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
          I agree the
          <a
            className="font-medium transition-colors hover:text-purple-950"
            href="#"
          >
            &nbsp; <span className="text-purple-950">Terms and Conditions</span>
          </a>
        </p>
      </label>
    </div>
    <button
      className="mt-6 block w-full select-none rounded-lg bg-[#EE4E34] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
    ...
    <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
      ...
      <Link to='/login'
        className="font-medium text-purple-950 transition-colors hover:text-blue-700"
